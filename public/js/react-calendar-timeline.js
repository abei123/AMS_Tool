	  ...
	  _createClass(Item, [{
	    ...
	    value: function render() {
      	...
      	createTooltip(style_tooltip, this.itemTitle, origin, destination, arrivalTime, departTime, this.props.item.itemProps.flightObject),
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'rct-item-overflow item-split-pane lol' },
	          _react2.default.createElement(
	            'div',
		...
		function createTooltip(style_tooltip, vfltNum, origin, destination, arrivalTime, departTime, fltObj ){
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						, _react2.default.createElement('img', {src:'img/AA_logo_small.png'} )
						,vfltNum
					)
					, _react2.default.createElement(
						'div'
			...
			function formAlertDiv(fltObj){
				...
				//if(alertMetalSwap!=null || alertGroundTime!=null || alertCrewChange!=null ){
					return _react2.default.createElement(
			...
			function createGroundTimeAlert(groundTime, minGroundTime){
				...
				//} else {
					return _react2.default.createElement(
						'div', {className: 'tooltip-data'}, 'Ground less than '+minGroundTime+' minutes'
					);
				//}
			}
	  ...
	  _createClass(Header, [{
	    ...
	    value: function render() {
	      ...
	      (0, _utils.iterateTimes)(canvasTimeStart, canvasTimeEnd, minUnit, timeSteps, function (time, nextTime) {
	        ...
	        var firstOfType = 0; //minUnitValue === (minUnit === 'day' ? 1 : 0);
	  ...
	  _createClass(TodayLine, [{
	    ...
	    value: function render() {
	      ...
	      if (currentTime > this.props.canvasTimeStart && currentTime < this.props.canvasTimeEnd) {
	        var ratio = (this.props.canvasWidth - 100) / (this.props.canvasTimeEnd - this.props.canvasTimeStart);
